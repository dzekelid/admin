...
created: "2018-08-27"
modified: "2018-08-27"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/admin/master/_listings/3scale/apis.md
...
- name: 3Scale Account Management API - User change Role to Admin (provider account)
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/admin/master/_listings/3scale/adminapiusersidadmin-xml-put-openapi.md
- name: 3Scale Account Management API - User change Role to Admin
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/admin/master/_listings/3scale/adminapiaccountsaccount-idusersidadmin-xml-put-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/admin/master/_listings/3scale/adminapiaccountsaccount-idusersidadmin-xml-put-openapi.md
x-common:
- type: x-api-gallery
